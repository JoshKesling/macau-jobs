...
class PreviousEmployment < ApplicationRecord
  ...
  validates :months, numericality: { only_integer: true },allow_blank: true
  validates :years, numericality: { only_integer: true }, allow_blank: true
  validates :ended_year, numericality: { only_integer: true }, allow_blank: true
